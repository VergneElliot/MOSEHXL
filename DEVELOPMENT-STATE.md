...
- **Floor service (in progress on `development`):** Phases A–C — PIN badge, map, open tickets, transfer/merge/à suivre, waiter snapshot + History filter (patch notes `455`–`460`).
