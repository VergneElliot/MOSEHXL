...
| **P3-Q8** | Pass 3 of unified error sweep: ad-hoc 4xx branches → `ValidationError`/`NotFoundError`/`AuthenticationError`/`AuthorizationError` | **In progress (2026-05-27):** auth + legal + printing routes migrated to typed 4xx errors; invitations/products/setup remain to fully close. | **L** |
