...
| **P3-Q12** | Expand `@mosehxl/types` and ban `any` in new frontend code | **In progress (2026-05-27):** expanded shared DTOs for catalog API records and removed `any` usage from `services/api/products.ts` + `services/api/categories.ts`; broader frontend `any` cleanup remains. | **L** |
