...
This dossier supports a **publisher self-certification** under CGI Article 286-I-3 bis
(ISCA). It is **not** an NF-525/LNE third-party certificate.

Final legal wording should be reviewed before signature. Technical content is an
engineering evidence package, not legal advice.
...
| File | Purpose |
|------|---------|
| `07-SIGNING-PACKET.md` | **Start here** — only remaining human steps |
| `01-SCOPE.md` | Approved B2C POS fiscal scope |
| `02-REFERENTIEL-MAPPING.md` | ISCA mapping (reviewed) |
