  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h5" gutterBottom>
        Audit Trail (Journal de Sécurité)
      </Typography>
      <Paper sx={{ mb: 2, p: 2 }}>
        ...
        <DialogContent>
          {selected && (
            <Box>
              ...
              <Typography>
                <b>Action:</b> {selected.action_type}
              </Typography>
              <Typography>
                <b>Ressource:</b> {selected.resource_type} {selected.resource_id}
              </Typography>
              <Typography>
                <b>Détails:</b>{' '}
                <pre style={{ whiteSpace: 'pre-wrap' }}>
                  {typeof selected.action_details === 'string'
                    ? selected.action_details
                    : JSON.stringify(selected.action_details, null, 2)}
                </pre>
              </Typography>
              <Typography>
                <b>IP:</b> {selected.ip_address}
              </Typography>
              <Typography>
                <b>User Agent:</b> {selected.user_agent}
              </Typography>
              <Typography>
                <b>Session:</b> {selected.session_id}
              </Typography>
            </Box>
          )}
        </DialogContent>
