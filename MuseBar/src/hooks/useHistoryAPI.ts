...
export const useHistoryAPI = (
  ...
  const processReturn = useCallback(async (returnData: ProcessReturnData) => {
  ...
  }, [apiService, setReturnLoading, setReturnError, setReturnSuccess, closeReturnDialog, loadOrders, loadStats]);
