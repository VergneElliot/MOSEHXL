...
import authPinRouter from './routes/authPin';
import pinSessionsRouter from './routes/pinSessions';
import staffAccountsRouter from './routes/staffAccounts';
...
app.use('/api/auth/pin/sessions', pinSessionsRouter);
app.use('/api/auth/users', staffAccountsRouter);
app.use('/api/auth/pin', authPinRouter);
