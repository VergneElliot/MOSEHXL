-- Enhanced User Management Schema for Multi-Tenant SaaS
-- Adds support for user invitations, email verification, password resets, and role management

-- First, add new columns to existing users table (backward compatible)
ALTER TABLE users 
...
CREATE TABLE IF NOT EXISTS user_invitations (
    ...
    establishment_id UUID, -- For future multi-tenant support
    ...
    CONSTRAINT valid_role CHECK (role IN ('cashier', 'manager', 'supervisor', 'establishment_admin', 'system_admin'))
);
