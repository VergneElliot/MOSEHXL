-- Migration: Create setup progress tracking tables
-- Date: 2025-09-04
-- Purpose: Track establishment setup completion progress and individual steps

-- Create establishment setup progress table
CREATE TABLE IF NOT EXISTS establishment_setup_progress (
    ...
    estimated_time_remaining INTEGER NOT NULL DEFAULT 0, -- in minutes
...
-- Create establishment setup steps table
