-- Migration: Create establishment status transitions table
-- Date: 2025-09-04
-- Purpose: Track establishment status changes for audit and lifecycle management

-- Create establishment status transitions table
